            ...
            <div className="space-y-6">
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-5">
                <h3 className="text-base md:text-lg font-bold text-white mb-2 drop-shadow-lg flex items-center">
                  ...
                  Lihat Kesegaran Produk Kami
                </h3>
                <p className="text-gray-200 text-sm drop-shadow-md">
                  Saksikan sendiri kesegaran dan kualitas premium selada hijau hidroponik kami! Setiap helai daun tumbuh sempurna dengan warna hijau cerah, tekstur renyah, dan nutrisi maksimal.
                </p>
              </div>
            </div>
